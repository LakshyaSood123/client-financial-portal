...
│   └── kyc-portal/         # KYC Portal Dashboard (React + Vite)
...
- **Fonts**: Satoshi (Fontshare) for headings + body at weights 300–900 (matches Crextio aesthetic), JetBrains Mono for monospace data. Main heading is 54px / weight 800 / tracking -0.04em.
