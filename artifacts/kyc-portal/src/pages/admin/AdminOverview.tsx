      ...
      <div className="px-8 pt-5 pb-8 space-y-4">
        ...
        <div className="flex gap-4 items-start">
          ...
          <div className="flex-1 min-w-0 flex flex-col gap-4">
              ...
              <motion.div style={{ ...tCard, gridColumn: "span 8" }} className="col-span-8" {...fade(0.36)}>
                ...
                <ResponsiveContainer width="100%" height={120}>
                  <BarChart data={volumeData} barGap={3} barCategoryGap="38%">
                    ...
                    <Tooltip cursor={{ fill: "rgba(13,18,33,0.06)", radius: 8 }} contentStyle={{ background: DARK, border: "none", borderRadius: 12, color: "#fff" }} labelStyle={{ color: "rgba(255,255,255,0.5)", fontSize: 11 }} itemStyle={{ color: "#fff" }} />
            ...
            {/* Recent activity — sits directly below charts, no gap */}
            <motion.div style={{ ...tCard, padding: 20 }} {...fade(0.42)}>
          ...
          {/* ── Dark right column — all 3 cards stacked ── */}
          <div className="flex flex-col gap-4" style={{ width: 252, flexShrink: 0 }}>
            ...
            <motion.div style={dCard} {...fade(0.18)}>
              <div className="flex items-center gap-2 mb-1">
                ...
                <p className="text-xs font-bold uppercase tracking-wider" style={{ color: "rgba(255,255,255,0.4)" }}>System Status</p>
              </div>
            ...
            <motion.div style={dCard} {...fade(0.24)}>
              <div className="flex items-center justify-between mb-3">
                <p className="text-xs font-bold uppercase tracking-wider" style={{ color: "rgba(255,255,255,0.4)" }}>Live Risk Alerts</p>
            ...
            {/* Upcoming review */}
            <motion.div style={dCard} {...fade(0.30)}>
              <div className="flex items-center gap-2 mb-1">
                <Shield className="w-3.5 h-3.5" style={{ color: "rgba(255,255,255,0.35)" }} />
                <p className="text-[10px] font-bold uppercase tracking-wider" style={{ color: "rgba(255,255,255,0.35)" }}>Upcoming Review</p>
              </div>
              <p className="font-display font-bold text-white mb-0.5" style={{ fontSize: 16, letterSpacing: "-0.02em" }}>
                Board Compliance Meeting
              </p>
              <p className="text-xs mb-4" style={{ color: "rgba(255,255,255,0.35)" }}>Mar 25 · 10:00 AM</p>
              ...
              <p className="text-[10px] font-bold uppercase tracking-wider mb-2" style={{ color: "rgba(255,255,255,0.3)" }}>Today's queue</p>
              <div className="space-y-2">
                {[{ label: "Approved", val: 38, color: "#4ade80" }, { label: "Pending", val: 14, color: "#fbbf24" }, { label: "Rejected", val: 5, color: "#f87171" }].map(b => (
                  <div key={b.label} className="flex items-center gap-3">
                    ...
                    <span className="text-[11px]" style={{ color: "rgba(255,255,255,0.3)", minWidth: 48 }}>{b.label}</span>
                  </div>
                ))}
              </div>
            </motion.div>
