    ...
    <AdminLayout>
      <div style={{ padding: "28px 32px" }}>
        ...
        <div style={{ display: "flex", gap: 10, marginBottom: 20, alignItems: "center" }}>
          <div style={{
            display: "flex", alignItems: "center", gap: 8, background: SURF_SUPPORT,
            borderRadius: 10, padding: "8px 14px", flex: 1, border: "1px solid rgba(13,18,33,0.07)",
          }}>
            <Activity style={{ width: 14, height: 14, color: MUTED }} />
            <input placeholder="Filter by event type, actor…" style={{
              background: "transparent", border: "none", outline: "none",
              fontSize: 13, color: TEXT, fontFamily: "'Satoshi', sans-serif", width: "100%",
            }} />
          </div>
          <button style={{ display: "flex", alignItems: "center", gap: 6, padding: "8px 14px", borderRadius: 10, border: "1px solid rgba(13,18,33,0.1)", background: SURF_SUPPORT, color: MUTED, cursor: "pointer", fontFamily: "'Satoshi', sans-serif", fontWeight: 600, fontSize: 13 }}>
        ...
        <div style={{ ...cardShell, background: SURF_DEFAULT, overflow: "hidden" }}>
          <div style={{
            display: "grid", gridTemplateColumns: "100px 200px 1fr 180px 90px",
            ...
            return (
              <div
                ...
                style={{
                  ...
                  borderBottom: i < MOCK_EVENTS.length - 1 ? "1px solid rgba(13,18,33,0.05)" : "none",
                  background: SURF_SUPPORT,
                }}
              >
                <code style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 11.5, color: MUTED }}>{ev.id}</code>
                <span style={{ fontSize: 12, color: "#60a5fa", fontFamily: "'JetBrains Mono', monospace" }}>{ev.type}</span>
                ...
                <div style={{
                  ...
                  background: sev.bg, borderRadius: 20, padding: "2px 9px", width: "fit-content",
                }}>
                  <span style={{ fontSize: 11.5, fontWeight: 700, color: sev.color, textTransform: "capitalize" }}>{ev.severity}</span>
                </div>
              </div>
            );
          })}
