  ...
  return (
    ...
    >
      ...
      <div className="px-5 pt-5 pb-4" style={{ borderBottom: "1px solid rgba(120,90,50,0.07)" }}>
        ...
        <p className="font-display font-bold" style={{ fontSize: 18, letterSpacing: "-0.01em", color: "#1C1917" }}>
          Acme Corp Ltd
        </p>
        <p className="text-xs mt-0.5" style={{ color: "#A09080" }}>KYB Verified · Growth Plan</p>
      </div>
      ...
      <div className="px-5 py-4 space-y-3">
        {FIELDS.map((field) => (
          <div key={field.label} className="flex items-center justify-between">
            <span className="text-xs" style={{ color: "#A09080" }}>{field.label}</span>
            <div className="flex items-center gap-1.5">
              ...
              {field.copyable && (
                <button
                  ...
                  style={{ color: copied ? "#F97316" : "#A09080" }}
      ...
      <div className="px-5 pb-4">
        <div className="flex items-center justify-between mb-2">
          <span className="text-[10px] uppercase tracking-wider font-semibold" style={{ color: "#A09080" }}>Monthly Usage</span>
          <span className="text-[10px] font-mono" style={{ color: "#F97316" }}>1,124 / 5,000 jobs</span>
        </div>
        ...
        <p className="text-[10px] mt-1.5" style={{ color: "#A09080" }}>22% of plan limit · resets Apr 1</p>
      </div>
      ...
      <div className="px-5 pb-4">
        <Link
          ...
          style={{ background: "#F2EBE1", color: "#F97316", border: "1px solid rgba(249,115,22,0.2)" }}
        >
          View Billing & Plan →
        </Link>
      </div>
