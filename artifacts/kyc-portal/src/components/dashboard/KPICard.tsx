  ...
  return (
    <div
      ...
      onMouseEnter={e => {
        ...
        (e.currentTarget as HTMLDivElement).style.boxShadow = `0 12px 32px rgba(0,0,0,0.1), 0 0 20px ${color}20`;
      }}
      onMouseLeave={e => {
    ...
    >
      ...
      {trend !== undefined && (
        <div style={{
          ...
          padding: "2px 8px",
          borderRadius: 999,
          background: trend >= 0 ? "rgba(0,184,150,0.12)" : "rgba(245,74,74,0.12)",
          color: trend >= 0 ? "#00b896" : "#f54a4a",
          border: `1px solid ${trend >= 0 ? "rgba(0,184,150,0.2)" : "rgba(245,74,74,0.2)"}`,
        }}>
          {trend >= 0 ? "+" : ""}{trend}%
        </div>
      )}
